...
export const STAGES: StageDefinition[] = [
  ...
  },
  {
    ...
    areas: [
      { label: 'きょうしつ', x: -11.9, z: 8.4, width: 16.2, depth: 12.2, color: 0xfff4c2, texture: 'school_classroom_floor', repeat: [4, 3], opacity: 0.98 },
      { label: 'ろうか', x: 2.4, z: 8.4, width: 10.2, depth: 12.2, color: 0xe5f5ff, texture: 'school_hall_floor', repeat: [3, 4], opacity: 0.96 },
      { label: 'げたばこ', x: 14.0, z: 8.4, width: 9.4, depth: 12.2, color: 0xffefd2, texture: 'school_hall_floor', repeat: [3, 4], opacity: 0.96 },
      { label: 'としょコーナー', x: -12.3, z: -6.4, width: 12.8, depth: 11.4, color: 0xe3f2ff, texture: 'school_classroom_floor', repeat: [4, 3], opacity: 0.92 },
      { label: 'ほけんしつまえ', x: 0.4, z: -6.4, width: 10.8, depth: 11.4, color: 0xffe5ec, texture: 'school_hall_floor', repeat: [3, 4], opacity: 0.94 },
      { label: 'こうてい', x: 13.6, z: -6.4, width: 13.8, depth: 11.4, color: 0xdaf5b8, texture: 'school_yard_floor', repeat: [3, 3], opacity: 0.98 }
    ],
    walls: [
      { label: 'きょうしつまえのかべA', x: -3.6, z: 11.8, width: 0.28, depth: 4.4 },
      { label: 'きょうしつまえのかべB', x: -3.6, z: 4.2, width: 0.28, depth: 3.2 },
      { label: 'げたばこまえのかべA', x: 8.5, z: 11.6, width: 0.28, depth: 4.0 },
      { label: 'げたばこまえのかべB', x: 8.5, z: 4.0, width: 0.28, depth: 2.8 },
      { label: 'したのかべ左', x: -12.5, z: 1.25, width: 12.0, depth: 0.28 },
      { label: 'したのかべ右', x: 1.8, z: 1.25, width: 5.6, depth: 0.28 },
      { label: 'こうていフェンスA', x: 7.3, z: -8.8, width: 0.24, depth: 5.2, height: 1.0, color: 0xb5d6b8 },
      { label: 'こうていフェンスB', x: 7.3, z: -2.4, width: 0.24, depth: 3.0, height: 1.0, color: 0xb5d6b8 }
    ],
    props: [
      { label: 'こくばん', x: -10.2, z: 12.55, width: 5.8, depth: 0.24, height: 1.55, color: 0x285d48 },
      { label: 'せんせいのつくえ', x: -15.0, z: 10.7, width: 2.4, depth: 1.1, height: 0.78, color: 0xc89458, texture: 'floor_wood' },
      { label: 'じかんわり', x: -14.0, z: 12.62, width: 1.8, depth: 0.18, height: 1.2, color: 0xfff6a8, collider: false },
      { label: 'まどA', x: -16.9, z: 8.2, width: 0.18, depth: 2.3, height: 1.3, color: 0xbfe8ff, collider: false },
      { label: 'まどB', x: -16.9, z: 4.9, width: 0.18, depth: 2.3, height: 1.3, color: 0xbfe8ff, collider: false },
      { label: 'つくえ1', x: -13.3, z: 7.7, width: 1.35, depth: 1.05, height: 0.66, color: 0xd8a35c },
      { label: 'つくえ2', x: -10.0, z: 7.7, width: 1.35, depth: 1.05, height: 0.66, color: 0xd8a35c },
      { label: 'つくえ3', x: -6.7, z: 7.7, width: 1.35, depth: 1.05, height: 0.66, color: 0xd8a35c },
      { label: 'つくえ4', x: -13.3, z: 4.7, width: 1.35, depth: 1.05, height: 0.66, color: 0xd8a35c },
      { label: 'つくえ5', x: -10.0, z: 4.7, width: 1.35, depth: 1.05, height: 0.66, color: 0xd8a35c },
      { label: 'つくえ6', x: -6.7, z: 4.7, width: 1.35, depth: 1.05, height: 0.66, color: 0xd8a35c },
      { label: 'ランドセルだな', x: -17.4, z: 4.0, width: 1.1, depth: 3.8, height: 1.25, color: 0xd85a51, texture: 'bookshelf_front' },
      { label: 'ろうかマット', x: 2.4, z: 8.4, width: 2.8, depth: 8.8, height: 0.06, color: 0x9bd6ff, collider: false, y: 0.08 },
      { label: 'てあらいば', x: 4.7, z: 11.2, width: 2.1, depth: 0.8, height: 0.82, color: 0xd9f8ff },
      { label: 'げたばこ', x: 15.5, z: 10.8, width: 4.3, depth: 1.0, height: 1.35, color: 0xc89458, texture: 'floor_wood' },
      { label: 'かさたて', x: 10.2, z: 5.8, width: 0.9, depth: 1.8, height: 1.1, color: 0x73c8f3 },
      ...
      { label: 'こうていライン', x: 13.6, z: -6.4, width: 10.8, depth: 0.16, height: 0.04, color: 0xffffff, collider: false, y: 0.07 },
    ...
    labels: [
      { text: 'きょうしつ', x: -11.9, z: 13.4, background: '#fff4c2' },
      { text: 'ろうか', x: 2.4, z: 13.4, background: '#e5f5ff' },
      { text: 'げたばこ', x: 14.0, z: 13.4, background: '#ffefd2' },
      { text: 'としょ', x: -12.3, z: -0.7, background: '#e3f2ff' },
      { text: 'ほけんしつ', x: 0.4, z: -0.7, background: '#ffe5ec' },
      { text: 'こうてい', x: 13.6, z: -0.7, background: '#daf5b8' }
    ],
